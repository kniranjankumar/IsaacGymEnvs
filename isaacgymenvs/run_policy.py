...
def apply_forces_to_rigid_bodies(_rigid_body_pos,_rigid_body_rot, _rigid_body_vel,_rigid_body_ang_vel):
        ...
        print("rod length error:", (torch.norm(rknee_tarsus_rod, dim=1) - knee_tarsus_rod_length))
...
trained_weights = torch.load("/home/dan/Projects/dynamic_motion_imitation/IsaacGymEnvs/isaacgymenvs/runs/Digit_hop_25-13-19-05/nn/Digit_hop_25-13-19-25.pth") # active toe?
# trained_weights = torch.load("/home/dan/Projects/dynamic_motion_imitation/IsaacGymEnvs/isaacgymenvs/runs/Digit_hop_passive_toe_26-15-06-16/nn/Digit_hop_passive_toe_26-15-06-35.pth")
...
# trained_weights = torch.load("/home/dan/Projects/dynamic_motion_imitation/IsaacGymEnvs/isaacgymenvs/runs/Digit_hop_24-12-04-29/nn/Digit_hop_24-12-04-49.pth")
...
digit_pose.p = gymapi.Vec3(-2, 0, 1.00)
...
humanoid_root_states[:] = torch.tensor([0, 2.0, 1.0, 0.0000e+00, 0.0000e+00, 0.0000e+00,
        1.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00, 0.0000e+00,
        0.0000e+00], device='cuda:0')
...
while not gym.query_viewer_has_closed(viewer):
    idx = 0 if idx >= len(mc_dof_pos) else idx
    dof_states[:humanoid_num_dofs,0] = mc_dof_pos[idx]
    dof_states[:humanoid_num_dofs,1] = mc_dof_vel[idx]
