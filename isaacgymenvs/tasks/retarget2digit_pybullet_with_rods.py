...
# digit_id = p.loadURDF("../assets/urdf/DigitRobot/DigitRobot/urdf/digit_model.urdf",[0,-1,1.1],[0,0,0,1])
...
right_heel = digit_bodies.index("right_heel")
left_heel = digit_bodies.index("left_heel")
right_heel_spring = digit_bodies.index("right_heel_spring")
left_heel_spring = digit_bodies.index("left_heel_spring")
...
c1 = p.createConstraint(digit_id, left_heel_spring, digit_id, left_heel, p.JOINT_POINT2POINT, [0,0,0], [0.5,0,0],[0,0,0])
c2 = p.createConstraint(digit_id, right_heel_spring, digit_id, right_heel, p.JOINT_POINT2POINT, [0,0,0], [0.5,0,0], [0,0,0])
# c3 = p.createConstraint(digit_id, 18, digit_id, 19, p.JOINT_POINT2POINT, [0,0,0], com2offset_knee_r,com2offset_tarsus2_r)
# c4 = p.createConstraint(digit_id, 19, digit_id, 20, p.JOINT_POINT2POINT, [0,0,0], com2offset_tarsus_r, com2offset_toe_r)

p.changeConstraint(c1, maxForce=10000)
p.changeConstraint(c2, maxForce=10000)
